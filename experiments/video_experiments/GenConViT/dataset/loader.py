...
def normalize_data():
    ...
    return {
        "train": transforms.Compose(
            [Aug(), transforms.Resize((224, 224)), transforms.ToTensor(), transforms.Normalize(mean, std)]
        ),
        ...
        "vid": transforms.Compose([transforms.Resize((224, 224)), transforms.Normalize(mean, std)]),
    }
